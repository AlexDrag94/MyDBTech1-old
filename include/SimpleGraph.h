...
public:
    ...
    static bool sortPairsFirst(const std::pair<uint32_t,uint32_t> &a, const std::pair<uint32_t,uint32_t> &b);
    static bool sortPairsSecond(const std::pair<uint32_t,uint32_t> &a, const std::pair<uint32_t,uint32_t> &b);
